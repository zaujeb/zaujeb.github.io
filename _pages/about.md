...
张无瑕，博士，副教授，硕士生导师，主要研究方向包括图像视频处理、机器学习、智能计算与应用。主持参与多项国家自然科学基金项目，发表SCI/EI论文若干篇。近年来主要聚焦于高分辨率遥感图像分析、深度学习与模式识别、视频行为识别等研究工作。

现为中国图象图形学学会（CSIG）会员，IEEE会员。担任《Neurocomputing》《Frontiers in Plant Science》等期刊审稿人。

联系方式：zhangwuxia@xupt.edu.cn
